...
<small>
  A ball positioned at the hill's summit can naturally roll downhill (spontaneous). Conversely, when
  the same ball is situated at the hill's base, it cannot autonomously roll upward
  (non-spontaneous).
</small>
