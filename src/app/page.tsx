  ...
  return (
    <div>
      ...
      <section className="flex gap-4 py-6 justify-center text-black items-center">
        ...
        <a href="https://twitter.com/diabeneyy" className=" opacity-60 hover:opacity-100 transition-all duration-300">
      ...
      <section className=" mt-6">
        ...
        <section className="grid grid-cols-2 mt-3 gap-4">
          ...
          <Link href={"/projects"} className=" flex items-center gap-0 underline hover:gap-1 transition-all duration-300">
